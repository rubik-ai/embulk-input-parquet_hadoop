...
import jp.co.cyberagent.parquet.msgpack.JSONIteratorMatcher;
import jp.co.cyberagent.parquet.msgpack.JSONLinesIterator;
...
public class TestParquetCompatibilityAgainstJson
{
    ...
    public void testing()
    {
        ...
        assertThat(parquet, CoreMatchers.is(JSONIteratorMatcher.sameAs(expected)));
    }
}
